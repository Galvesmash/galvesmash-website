  ...
  <section class="py-8 py-md-12">
    <v-row class="ma-0">
      ...
      <v-col class="mb-2 mb-md-6 pa-0 pl-md-12" sm="12" md="8" cols="12">
        <h2 class="mb-6 font-italic font-weight-bold text-h4 text-primary text-uppercase">{{ t('about.aboutMe.title') }}!</h2>

        <about-me />
      </v-col>

      <v-col class="mt-10 mt-md-16 pa-0" cols="12">
        <h3 class="mb-6 font-italic font-weight-bold text-md-center text-h4 text-primary text-uppercase">{{ t('about.skills.title') }}</h3>
